...
import {
  Container, Typography, Box, Grid, Tabs, Tab, Paper, 
...
const ResourcesPage = () => {
  ...
  // Get resources data
  const { organizations, helplines, online_resources, educational_resources, legal_support } = resourcesData;
  ...
  const filterResources = (resources) => {
    ...
    return resources.filter(resource => 
      ...
      (resource.services && resource.services.some(service => service.toLowerCase().includes(term)))
    );
  };
  
  // Get filtered resources for current tab
    ...
    >
      ...
      <IntroBox>
        <Typography variant="body1" paragraph>
          Access to support services, community organizations, and reliable information is crucial for LGBTQAI+ individuals.
          Below you'll find a comprehensive list of resources available across India. These organizations and services
          can provide assistance, community connection, and valuable information.
        </Typography>
        <Typography variant="body1">
          Use the tabs below to navigate between different types of resources, and use the search box to find specific resources.
        </Typography>
      </IntroBox>
      ...
      <Box sx={{ mt: 4, textAlign: 'center' }}>
        <Typography variant="body2" color="text.secondary">
          Note: The information provided may change over time. Always verify contact details 
          before reaching out to any organization.
        </Typography>
      </Box>
    </motion.div>
  );
