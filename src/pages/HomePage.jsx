        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            <StatCard>
              ...
              <Typography variant="body1" color="text.secondary">
                Comprehensive information about the history, legal landscape, and social context of LGBTQAI+ issues in India.
              </Typography>
            </StatCard>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <StatCard>
              ...
              <Typography variant="body1" color="text.secondary">
                Learn about different sexual orientations, gender identities, and the spectrum of human diversity.
              </Typography>
            </StatCard>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <StatCard>
              ...
              <Typography variant="body1" color="text.secondary">
                Access to support organizations, helplines, and resources to help create more inclusive communities.
              </Typography>
            </StatCard>
          </Grid>
        </Grid>
