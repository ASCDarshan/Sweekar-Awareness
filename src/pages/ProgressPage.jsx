    ...
    >
      ...
      <Box sx={{ mt: 6, mb: 4, textAlign: 'center' }}>
        ...
        <Typography variant="body1">
          The more you learn, the better you can understand and support the LGBTQAI+ community.
          Keep exploring sections to complete your tutorial and earn all badges!
        </Typography>
      </Box>
    </motion.div>
  );
